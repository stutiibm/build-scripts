...
#Install
if ! (bazel --host_jvm_args=-Xms1g --host_jvm_args=-Xmx6g --bazelrc=$BAZEL_RC_DIR/tensorflow.bazelrc build --local_cpu_resources=HOST_CPUS*0.50 --local_ram_resources=HOST_RAM*0.50 --config=opt ${BUILD_TARGET}) ; then  
