...
# GITHUB_PACKAGE_VERSION (passed as EXTRA_ARGS=$3) before any
# post-processing (sha, suffix, license injection) takes place.
#
...
#
# Skipped when EXTRA_ARGS is empty (no version was passed in).
# Override script path via $5  (default: gha-script/check_wheel_version.py).
# ---------------------------------------------------------------------------
